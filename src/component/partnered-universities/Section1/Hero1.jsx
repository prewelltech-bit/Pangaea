      ...
      <div className="edwise-container">
        ...
        <div className="edwise-left">
          <h1>
            ...
            across <span className="highlight">5 Countries</span>
          </h1>
          ...
          <p>
            ...
            best for making their dreams come true. With an impressive roster
            of more than 200 foreign universities, we offer Indian students
